// // frontend/app/page.js - FIXED VERSION WITH DISTANCE, ICONS, SPECIALTY FILTER
// "use client";
// import { useEffect, useState } from "react";
// import { AuthProvider, useAuth } from "../components/AuthProvider";
// import { MapPin, Phone, Bed, Filter, Search, Calendar, X, Navigation, Heart, Eye, Stethoscope, Activity } from "lucide-react";
...
//       // Calculate distances and add to each hospital
...
//         // Check if insurance is covered
//         const insuranceCovered = hospital.acceptsInsurance?.some(ins => 
...
//     // Specialty filter
//     if (specialty && !h.specialties?.includes(specialty.toLowerCase())) return false;
...
//         <Marker 
//           position={[user.address.lat, user.address.lon]}
//           icon={userIcon}
//         >
//           <Popup>
